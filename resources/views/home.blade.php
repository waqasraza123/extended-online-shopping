...
@section('subheading', 'Control panel')
@section('head')
    <!-- Ionicons -->
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4 col-xs-3">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="#" class="small-box-footer">Todays' Summary <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-4 col-xs-3">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{$sales->sum('revenue')}}<sup style="font-size: 20px">Rs</sup></h3>
                    ...
                    <a href="#" class="small-box-footer">Todays' Revenue <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        ...
        <div class="row">
            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <!-- quick email widget -->
                @include('user.partials.email-support')
